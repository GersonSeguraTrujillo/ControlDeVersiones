  ...
  public   class CN_GastosFundacion
    {
        ...
        public string Registrar(GastosFundacion obj, out string Mensaje)
        {
            ...
            if (obj.oFundacion.IdFundacion == 0)
            {
                Mensaje = "Debe Seleccionar la fundacion para llevar el control del gasto";
            }

            else if (obj.oGastos.IdGasto == 0)
            {
                Mensaje = "Debe Seleccionar el gasto para llevar el control del gasto quiere registra";
            }
