  ...
  public   class CN_Paciente
    {
        ...
        public int Registrar(Paciente obj, out string Mensaje)
        {
            ...
            {
                Mensaje = "El apillido no peuede estar vacio";
            }
          
            else if (string.IsNullOrEmpty(obj.Correo) || string.IsNullOrWhiteSpace(obj.Correo))
            {
                Mensaje = "El correo no peuede estar vacio";
            }
            else if (string.IsNullOrEmpty(obj.Enfermedad) || string.IsNullOrWhiteSpace(obj.Enfermedad))
            {
                Mensaje = "La enfermedad no peuede estar vacia";
            }

            else  if  (obj.edad == 0)
            {
                Mensaje = "El edad del paciente  no puede ser vacia";
            }
