...
namespace Capa_Negocio
{
    public class CN_GastosMedicos
    {
        ...
        public List<DetalleCita> ListarDetalleCita(int IdCita)
        {
        ...
        public TotalCita VerTotalCita(int IdCita)
        {
            ...
            return objCapaDato.VerTotalcita(IdCita);
        }
        public InformacionCita VerInfoCita(int IdCita)
        {

            return objCapaDato.VerInfoCita(IdCita);
        }
        public int Registrar(GastosMedicos obj, out string Mensaje)
        {
         ...
         if (obj.IdCita ==0)
            ...
            {
                Mensaje = "Revise el campo cantidad: No puede estar vacio o a escrito una coma o un punto";
            }
