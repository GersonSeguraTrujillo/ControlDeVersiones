  ...
  public   class CN_Cita
    {
        ...
        public string Registrar(Cita obj, out string Mensaje)
        {
         ...
         if (string.IsNullOrEmpty(obj.Cintomas) || string.IsNullOrWhiteSpace(obj.Cintomas))
            ...
            {
                Mensaje = "Falta el precio de la cita, a escrito letras en el vez de numeros o a escrito una coma en lugar de punto";
            }
        ...
        public bool DarObservaciones(DarObservaciones obj, out string Mensaje)
        {
            Mensaje = string.Empty;
            ...
            {
                Mensaje = "Falta las observaciones";
            }
            ...
            if (string.IsNullOrEmpty(Mensaje))
            {
                ...
                return objCapaDato.DarObservaciones(obj, out Mensaje);
            }
            else
            {
                return false;
